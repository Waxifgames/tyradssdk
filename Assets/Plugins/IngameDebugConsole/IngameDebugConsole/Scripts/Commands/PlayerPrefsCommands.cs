...
namespace Plugins.IngameDebugConsole.Scripts.Commands
{
	public static class PlayerPrefsCommands
	{
		...
		public static string PlayerPrefsGetInt( string key ) 
			=> !PlayerPrefs.HasKey( key ) ? "Key Not Found" : PlayerPrefs.GetInt( key ).ToString();
		...
		public static string PlayerPrefsGetFloat( string key ) 
			=> !PlayerPrefs.HasKey( key ) ? "Key Not Found" : PlayerPrefs.GetFloat( key ).ToString(CultureInfo.InvariantCulture);
		...
		public static string PlayerPrefsGetString( string key ) 
			=> !PlayerPrefs.HasKey( key ) ? "Key Not Found" : PlayerPrefs.GetString( key );
